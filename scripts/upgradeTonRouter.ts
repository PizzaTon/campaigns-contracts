...
export async function run(provider: NetworkProvider) {
    ...
    const router = provider.open(TonRouter.createFromAddress(Address.parse('kQBUI6gHTITNecVR-XZNZx6Zi8xPQlCzrxvFA309zmdHQaYt')));

    const newCode =  await compile('TonRouter');
