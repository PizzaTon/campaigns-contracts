...
export class JettonMinter implements Contract {
    ...
    protected static jettonInternalTransfer(jetton_amount: bigint,
        ...
        return beginCell()
            .storeUint(OperationCodes.internal.jetton.internalTransfer, 32)
    ...
    static mintMessage(from: Address, to: Address, jetton_amount: bigint, forward_ton_amount: bigint, total_ton_amount: bigint, query_id: number | bigint = 0) {
        const mintMsg = beginCell().storeUint(OperationCodes.internal.jetton.internalTransfer, 32)
            .storeUint(0, 64)
            .storeCoins(jetton_amount)
            .storeAddress(null)
        ...
        return beginCell().storeUint(OperationCodes.internal.jetton.mint, 32).storeUint(query_id, 64) // op, queryId
            .storeAddress(to)
    ...
    */
    ...
    static changeAdminMessage(newOwner: Address) {
        return beginCell().storeUint(OperationCodes.internal.updateOwner, 32).storeUint(0, 64) // op, queryId
    ...
    static changeContentMessage(content: Cell) {
        return beginCell().storeUint(OperationCodes.internal.jetton.updateContent, 32).storeUint(0, 64) // op, queryId
            .storeRef(content)
            .endCell();
    }
